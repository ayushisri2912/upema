      ...
      <div className="bg-white border-b border-gray-100 transition-all duration-300">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 min-h-[90px] md:min-h-[105px] py-4 flex items-center justify-between gap-4">
          ...
          <div className="hidden lg:flex items-center gap-7">
            ...
            <Link
              to="/membership"
              className="ml-2 inline-flex items-center justify-center bg-[#1279CF] hover:bg-[#FAD06A] text-slate-900 font-bold text-[13px] uppercase tracking-wider px-6 py-2.5 rounded-[6px] shadow-sm hover:shadow-md active:scale-[0.98] transition-all duration-300"
            >
